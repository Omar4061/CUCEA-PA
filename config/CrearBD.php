...
echo "Función hashPassword definida correctamente<br>";
...
$usuarios = [
    ...
    [2104567890, 'Denisse', 'Murillo', 'denisse.murillo@cucea.udg', '123', 'Masculino', 2, '#FF0000'],
...
foreach ($usuarios as $index => $usuario) {
    ...
    if ($stmt->execute()) {
        echo "Usuario " . ($index + 1) . " insertado correctamente<br>";
    } else {
        echo "Error insertando usuario " . ($index + 1) . ": " . $stmt->error . "<br>";
    }
}
